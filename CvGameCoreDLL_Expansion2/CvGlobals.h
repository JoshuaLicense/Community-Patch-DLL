...
//Weight for City Target if Liberation Quest Active
	...
	GD_INT_DEF(SUPPLY_TRUCKS_MOVEMENT)
	GD_INT_DEF(SUPPLY_TRUCKS_PLOT_LIMIT)

	GD_INT_DEF(CITY_MAX_PLOT_CONTROL_RANGE)
	GD_INT_DEF(UNIT_MAX_PLOT_CONTROL_RANGE)

	GD_INT_DEF(MAX_HEALING_PERCENTAGE)
	GD_INT_DEF(HEALING_HIGH_DANGER)
	GD_INT_DEF(HEALING_MEDIUM_DANGER)
	GD_INT_DEF(HEALING_LOW_DANGER)

	GD_INT_DEF(HEAVY_FUEL_RATIONING)
	GD_INT_DEF(MEDIUM_FUEL_RATIONING)
	GD_INT_DEF(LIGHT_FUEL_RATIONING)

	GD_INT_DEF(HEAVY_RATIONING_MOVES)
	GD_INT_DEF(MEDIUM_RATIONING_MOVES)
	GD_INT_DEF(LIGHT_RATIONING_MOVES)

	GD_INT_DEF(HEAVY_RATIONING_CONSUMPTION)
	GD_INT_DEF(MEDIUM_RATIONING_CONSUMPTION)
	GD_INT_DEF(LIGHT_RATIONING_CONSUMPTION)

	GD_INT_DEF(OCCUPIED_PRODUCTION_MODIFIER)
	GD_INT_DEF(OCCUPIED_CITY_CONNECTION_MODIFIER)
#endif
...
#endif
#if defined(MOD_WWII_MISC)
	GD_INT_DECL(SUPPLY_TRUCKS_MOVEMENT);
	GD_INT_DECL(SUPPLY_TRUCKS_PLOT_LIMIT);

	GD_INT_DECL(CITY_MAX_PLOT_CONTROL_RANGE);
	GD_INT_DECL(UNIT_MAX_PLOT_CONTROL_RANGE);

	GD_INT_DECL(MAX_HEALING_PERCENTAGE);
	GD_INT_DECL(HEALING_HIGH_DANGER);
	GD_INT_DECL(HEALING_MEDIUM_DANGER);
	GD_INT_DECL(HEALING_LOW_DANGER);

	GD_INT_DECL(HEAVY_FUEL_RATIONING);
	GD_INT_DECL(MEDIUM_FUEL_RATIONING);
	GD_INT_DECL(LIGHT_FUEL_RATIONING);

	GD_INT_DECL(HEAVY_RATIONING_MOVES);
	GD_INT_DECL(MEDIUM_RATIONING_MOVES);
	GD_INT_DECL(LIGHT_RATIONING_MOVES);

	GD_INT_DECL(HEAVY_RATIONING_CONSUMPTION);
	GD_INT_DECL(MEDIUM_RATIONING_CONSUMPTION);
	GD_INT_DECL(LIGHT_RATIONING_CONSUMPTION);

	GD_INT_DECL(OCCUPIED_PRODUCTION_MODIFIER);
	GD_INT_DECL(OCCUPIED_CITY_CONNECTION_MODIFIER);
#endif
